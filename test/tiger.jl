"""
Tiger POMDP from POMDPModels.jl (used only for testing, copied to circumvent a dependency)
"""
...
POMDPs.states(::TigerPOMDP) = (false, true)
POMDPs.observations(::TigerPOMDP) = (false, true)

POMDPs.stateindex(::TigerPOMDP, s::Bool) = Int64(s) + 1
POMDPs.actionindex(::TigerPOMDP, a::Int) = a + 1
POMDPs.obsindex(::TigerPOMDP, o::Bool) = Int64(o) + 1
...
function POMDPs.transition(pomdp::TigerPOMDP, s::Bool, a::Int64)
...
function POMDPs.observation(pomdp::TigerPOMDP, a::Int64, sp::Bool)
...
function POMDPs.observation(pomdp::TigerPOMDP, s::Bool, a::Int64, sp::Bool)
    return observation(pomdp, a, sp)
end


function POMDPs.reward(pomdp::TigerPOMDP, s::Bool, a::Int64)
    r = 0.0
...
POMDPs.reward(pomdp::TigerPOMDP, s::Bool, a::Int64, sp::Bool) = reward(pomdp, s, a)


POMDPs.initialstate(pomdp::TigerPOMDP) = BoolDistribution(0.5)

POMDPs.actions(::TigerPOMDP) = 0:2
...
POMDPs.initialobs(p::TigerPOMDP, s::Bool) = observation(p, 0, s) # listen 